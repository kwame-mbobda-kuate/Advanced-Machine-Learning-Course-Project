...
def get_word_flips(fill, num_candidates=10):
    ...
    all_results = sum(
        [
            sorted(results[length], key=lambda x: -x[1])
...
file_path = r"C:\Users\tbonn\OneDrive\Bureau\projet ml\Advanced-Machine-Learning-Course-Project\src\solver\Mar2321.puz"

# Charger le puzzle
puzzle = puz.read(file_path)

print(convert_puz(file_path))
